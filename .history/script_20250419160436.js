    ...
    .then(data => {
      ...
      data.contents.forEach(block => {
        if (block.image?.display?.url) {
          ...
          // Create a wrapper for the image with random alignment
          ...
          imgWrapper.style.justifyContent = randomAlignment;  // Apply random alignment to the image wrapper
          imgWrapper.appendChild(img);

          contentEl.appendChild(imgWrapper);  // Add the image wrapper to the contentEl
        }
